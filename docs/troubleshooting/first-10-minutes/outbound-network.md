...
![Azure portal Networking blade for app-test-20251107 Web App, with toolbar Refresh / Troubleshoot / Send us your feedback. Left column Inbound traffic configuration shows Public network access "Enabled with no access restrictions (Using default behavior)", App assigned address "Not configured", Private endpoints "0 private endpoints", Inbound IPv4 addresses <ip-redacted>, Inbound IPv6 addresses 2603:1040:f05:3::208, and Optional inbound services row for Azure Front Door with View details link. Right column Outbound traffic configuration shows Virtual network integration "Not configured", Hybrid connections "Not configured", Outbound DNS "Default (Azure-provided)", and long list of Outbound IPv4 and IPv6 addresses. Bottom Integration subnet configuration section shows NAT gateway N/A, Network security group N/A, User defined route N/A.](../../assets/troubleshooting/networking/01-networking-hub.png)
