...
if [[ $# -ne 1 ]]; then
    ...
    echo "Example: $0 https://app-winjavatimeoutl1-abcd.azurewebsites.net"
    exit 1
fi
...
echo
echo "Warm-up complete. Proceed with: bash collect-effective-config.sh --preflight <APP_NAME> <RESOURCE_GROUP_NAME> ./results"
