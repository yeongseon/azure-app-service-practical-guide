...
Issue: https://github.com/yeongseon/azure-app-service-practical-guide/issues/64
...
The validator in :mod:`tools.validate_frontmatter` enforces this policy on an
ongoing basis; this script exists for the one-time R2 cleanup tied to PR #89.
