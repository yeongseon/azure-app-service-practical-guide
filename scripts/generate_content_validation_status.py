...
def generate_dashboard(
    ...
    lines.append(
        ...
        "App Service behavior (a documented limit, default, or feature). "
        ...
        f"text `{TAUTOLOGICAL_CLAIM_MARKER}` triggers a fail-fast in both "
        "this generator and `tools/validate_frontmatter.py`."
    )
    lines.append("")
